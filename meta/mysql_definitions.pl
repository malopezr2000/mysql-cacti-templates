      ...
      {  base_value => '1000',
         dt         => {
            ...
            transaction_lock_time => {
               data_source_type_id => '1',
               hash => 'hash_08_VER_3a2b84efcc69304a9362a08cda9c1da2'
            },
            transaction_time => {
               data_source_type_id => '1',
               hash => 'hash_08_VER_eebbc6aae3eae872da81fdf51cdf3b63'
            }
         },
         ...
         items => [
            ...
            {  color  => '008A77',
               hashes => [
                  'hash_10_VER_da7cc5076c20eb4dd7cd8b7005b5a78c',
                  'hash_10_VER_08dbaa0ba9d48310029556ffc1694b70',
                  'hash_10_VER_4e2f590c5dd7fde2b176181dc1cb6349',
                  'hash_10_VER_4197391512332c371d61c0413845bbd1'
               ],
               item => 'transaction_time',
               task => 'hash_09_VER_9b7ede3cb56c016117f8ad798feca2f6',
               type => 'LINE1'
            },
            {  color  => '8D00BA',
               hashes => [
                  'hash_10_VER_acab0ed39cc9248741adc1ea80ec73c1',
                  'hash_10_VER_ac8025ab358d0d25dfbf6fb8fd733a67',
                  'hash_10_VER_7fb1c36d3bc9c35317e868c0ff7ff103',
                  'hash_10_VER_378bec8aeabd7610226342495813a139'
               ],
               item => 'transaction_lock_time',
               task => 'hash_09_VER_c4b2e1795809d0bf27a6605da2a29b2e',
               type => 'LINE1'
            }
         ],
   ...
   inputs => {
      'Get MySQL Stats' => {
         ...
         outputs => {
            ...
            transaction_lock_time =>
               'hash_07_VER_8c83ac7026cf4d67499da7c3e37bc027',
            transaction_time => 'hash_07_VER_2f9d51ba1056039ebaa14b1a774c8878',
            unflushed_log    => 'hash_07_VER_13f0bccec0c2682a2dd1c0a0264496f2',
            unpurged_txns    => 'hash_07_VER_3f8a6e0a1bee3982f688212d28e6df5b'
         },
         type_id => 1
      }
   },
